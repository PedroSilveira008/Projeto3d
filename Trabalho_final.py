    ...
    with abas[3]:
        ...
        with aba4_2:
            if st.session_state.nivel == 'usuario':
                ...
                custo_grama = st.slider('Custo do filamento por grama (R$)', min_value=st.session_state.custo_min, max_value=st.session_state.custo_max, value=(st.session_state.custo_min + st.session_state.custo_max) / 2, step=0.01)
